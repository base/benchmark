...
func NewOPProgramBenchmark(genesis *core.Genesis, log log.Logger, opProgramBin string, l2RPCURL string, l1Chain *fakel1.FakeL1Chain, batcherKey *ecdsa.PrivateKey) ProofProgramBenchmark {
...
func (o *opProgramBenchmark) writeConfigFiles() error {
	...
	if err = json.NewEncoder(genesisFile).Encode(o.l2Genesis); err != nil {
