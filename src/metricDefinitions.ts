...
export const CHART_CONFIG = {
  ...
  reth_sync_execution_transaction_execution_histogram_avg: {
    type: "line",
    title: "Transaction Execution Duration",
    description: "Average time spent executing an individual transaction",
    unit: "s",
  },
  reth_sync_execution_transaction_wait_histogram_avg: {
    type: "line",
    title: "Transaction Wait Duration",
    description: "Average time transactions wait before execution",
    unit: "s",
  },
  reth_sync_execution_accounts_updated_histogram_avg: {
    type: "line",
    title: "Accounts Updated",
    description: "Average number of accounts updated during execution",
    unit: "count",
  },
  reth_sync_execution_storage_slots_updated_histogram_avg: {
    type: "line",
    title: "Storage Slots Updated",
    description: "Average number of storage slots updated during execution",
    unit: "count",
  },
  ...
  reth_sync_block_validation_total_duration_avg: {
    type: "line",
    title: "Total Validation Duration",
    description: "Average total time spent validating a canonical block",
    unit: "s",
  },
  reth_sync_block_validation_deferred_trie_compute_duration_avg: {
    type: "line",
    title: "Deferred Trie Compute Duration",
    description:
      "Average time deferred trie computation takes during validation",
    unit: "s",
  },
  reth_sync_block_validation_hashed_post_state_size_avg: {
    type: "line",
    title: "Hashed Post-state Size",
    description:
      "Average size of the hashed post-state prepared for validation",
    unit: "count",
  },
  reth_sync_block_validation_trie_updates_sorted_size_avg: {
    type: "line",
    title: "Sorted Trie Updates",
    description: "Average number of sorted trie updates in a validated block",
    unit: "count",
  },
  ...
  reth_consensus_engine_persistence_save_blocks_batch_size_avg: {
    type: "line",
    title: "Persistence Batch Size",
    description:
      "Average number of blocks written in one persistence operation",
    unit: "blocks",
  },
  reth_consensus_engine_beacon_backpressure_active: {
    type: "line",
    title: "Engine Backpressure Active",
    description:
      "Whether execution-engine backpressure was active for the sample",
    unit: "count",
  },
  ...
  reth_tree_root_sparse_trie_total_duration_histogram_avg: {
    type: "line",
    title: "Sparse Trie Total Duration",
    description: "Average total sparse-trie processing time during validation",
    unit: "s",
  },
  ...
  reth_tree_root_sparse_trie_final_update_duration_histogram_avg: {
    type: "line",
    title: "Sparse Trie Final Update Duration",
    description: "Average sparse-trie final-update time during validation",
    unit: "s",
  },
  reth_tree_root_sparse_trie_cache_wait_duration_histogram_avg: {
    type: "line",
    title: "Sparse Trie Cache Wait",
    description: "Average time sparse-trie work waits on the cache",
    unit: "s",
  },
  reth_tree_root_sparse_trie_channel_wait_duration_histogram_avg: {
    type: "line",
    title: "Sparse Trie Channel Wait",
    description: "Average time sparse-trie work waits on internal channels",
    unit: "s",
  },
  reth_tree_root_sparse_trie_reveal_multiproof_duration_histogram_avg: {
    type: "line",
    title: "Sparse Trie Reveal Multiproof",
    description: "Average multiproof reveal time during sparse-trie processing",
    unit: "s",
  },
