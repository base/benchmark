...
// perspective. Grouping by workload makes that view useful immediately;
// users can still choose Role to compare node roles explicitly.
const DEFAULT_COMPARISON_METRIC = "TransactionPayload";
...
const ChartSelector = ({
  ...
  const {
    ...
    setByMetric,
    role,
  } = useBenchmarkFilters(runsWithRoles, DEFAULT_COMPARISON_METRIC);
