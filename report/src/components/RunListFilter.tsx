...
const RunListFilter = ({
  ...
  const downloadTrigger = (
    <button
      className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-150"
    ...
    >
      ...
      <svg className={clsx("w-4 h-4 transition-transform duration-150", isDownloadOpen && "rotate-180")} fill="currentColor" viewBox="0 0 20 20">
